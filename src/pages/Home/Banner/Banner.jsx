import banner1 from '../../../assets/images/banner/dollBanner1.jpg'
import banner2 from '../../../assets/images/banner/dollBanner2.jpg'
import banner3 from '../../../assets/images/banner/dollBanner3.jpg'
import banner4 from '../../../assets/images/banner/dollBanner4.jpg'
const Banner = () => {
    return (
            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute h-full flex justify-between items-center transform -translate-y-1/2 left-0 right-0 top-1/2 bg-gradient-to-r from-[#444444] to-[rgba(21,21,21, 0)] rounded-lg">
                    <div className='text-center mx-auto text-cyan-50 space-y-7'>
                        <h2 className='text-6xl'>Qualitative Handmade Dolls</h2>
